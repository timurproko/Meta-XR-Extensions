...
public class UITKControllerTriggerInteraction : MonoBehaviour
{
    [SerializeField] private UITKElementPicker _elementPicker;
    [SerializeField] private UITKControllerTriggerFromDataSource _triggerSourceLeft;
    [SerializeField] private UITKControllerTriggerFromDataSource _triggerSourceRight;
    ...
    {
        if (UITKInteractionBlocker.IsBlocked) return;
